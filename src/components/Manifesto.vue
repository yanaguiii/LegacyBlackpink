<template>
  <section class="bp-manifesto" id="program">
    ...
    <blockquote v-reveal="120" class="bp-manifesto__quote">
      ...
      Levamos ao palco o show da BLACKPINK com a mesma energia, esforço e produção do original — <em>para que cada noite tenha o sentimento de um show de verdade.</em>
    </blockquote>
    <div v-reveal="260" class="bp-manifesto__cite">Legacy Blackpink Cover · estreia · 2026</div>
  </section>
</template>
